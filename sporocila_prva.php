...
$query = "select m.id AS 'id', u.first_name, u.last_name, m.tuser_id, m.subject, m.date from messages m inner join users u on u.id=m.fuser_id where (m.tuser_id=".$_SESSION['user_id'].") and (seen=0) order by m.date desc";
